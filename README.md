...
* **Start-ClusterCapacitySummary**: creates a XLSX summary on CPU/vRAM allocation, usage, availability, and contention for each vSphere vSphere Cluster. CPU Usage is calculated for 9AM to 5PM and 5PM to 9AM. Connects to vROPs with REST and PowerShell. Requires CPU contention report in vROPs<br>
