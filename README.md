...
* **New-VMHost**: work in progress. accelerates ESXi VMHost build times. Modifies ILO users, creates custom ESXi ISO with ImgBurn, adds vMotion IP, sets NTP, configures persistent logging, and changes advanced settings<br>
